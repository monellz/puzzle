...
#${MLIR_BUILD_DIR}/bin/mlir-tblgen ${PROJECT_DIR}/include/puzzle/mlir/puzzle_ops.td -I=${PROJECT_DIR}/include -I=${MLIR_SRC_DIR}/include --gen-op-interface-decls -o ${PROJECT_DIR}/include/puzzle/mlir/puzzle_interface.h.inc
#${MLIR_BUILD_DIR}/bin/mlir-tblgen ${PROJECT_DIR}/include/puzzle/mlir/puzzle_ops.td -I=${PROJECT_DIR}/include -I=${MLIR_SRC_DIR}/include --gen-op-interface-defs -o ${PROJECT_DIR}/include/puzzle/mlir/puzzle_interface.cpp.inc
